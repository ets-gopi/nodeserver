...
const createProperty=async(req,res,next)=>{
    try {
        ...
        await userModel.findByIdAndUpdate(req.payload.id,{$addToSet:{
...
const updatePropertyById=async(req,res,next)=>{
    ...
    try {
        ...
        if(req.body.location){
            req.body={...req.body,location:{...propertyObj.location,...req.body.location}}
           
        }
        if(req.body.contactInfo){
            req.body={...req.body,contactInfo:{...propertyObj.contactInfo,...req.body.contactInfo}}
        }
...
const propertyInfo={createProperty,updatePropertyById,deletePropertyById,getPropertyById,getAllProperties};
